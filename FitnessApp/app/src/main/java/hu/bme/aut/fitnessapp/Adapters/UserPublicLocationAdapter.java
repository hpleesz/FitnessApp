...
public class UserPublicLocationAdapter extends RecyclerView.Adapter<UserPublicLocationAdapter.LocationViewHolder> {

    private final List<PublicLocation> items;

    private UserPublicLocationAdapter.LocationItemDeletedListener del_listener;
    private UserPublicLocationAdapter.LocationItemSelectedListener select_listener;

    public UserPublicLocationAdapter(UserPublicLocationAdapter.LocationItemDeletedListener del_listener, UserPublicLocationAdapter.LocationItemSelectedListener select_listener, ArrayList<PublicLocation> list) {
    ...
    public LocationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UserPublicLocationAdapter.LocationViewHolder(itemView);
    }
