...
public class EditPublicLocationActivity extends AppCompatActivity implements EquipmentAdapter.OnCheckBoxClicked{
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isValid()) {
                    ...
                    Intent intent = new Intent(EditPublicLocationActivity.this, GymMainActivity.class);
    ...
    private void loadEquipment() {
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                initRecyclerView();
                adapter.setCheckedEquipmentList(publicLocation.equipment);
    ...
    public void initializeEditTexts() {
        ...
        name.setText(publicLocation.name);
        description.setText(publicLocation.description);
        country.setText(publicLocation.country);
        city.setText(publicLocation.city);
        zip.setText(publicLocation.zip);
        address.setText(publicLocation.address);

        int j = 0;
        for(int i = 0; i < publicLocation.open_hours.size(); i++) {
            openHours.get(j).setText(publicLocation.open_hours.get(i)[0]);
            j++;
            openHours.get(j).setText(publicLocation.open_hours.get(i)[1]);
            j++;
        }
    ...
    public void setDatePickers() {
        ...
        for(final EditText ET : openHours) {
            ET.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    TimePickerDialog timePickerDialog = new TimePickerDialog(EditPublicLocationActivity.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
    ...
    private PublicLocation getLocationItem() {
        ...
        PublicLocation location = new PublicLocation(publicLocation.id, name.getText().toString(), adapter.getCheckedEquipmentList(), openClose, description.getText().toString(),
